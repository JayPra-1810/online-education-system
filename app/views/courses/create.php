...
<div class="max-w-4xl mx-auto w-full">
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-500 mt-1">Fill in the basic details to start building your course.</p>
        </div>
        <a href="<?= URL_ROOT ?>/creator/dashboard" class="text-gray-500 hover:text-gray-900 font-medium text-sm transition flex items-center gap-1">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <form action="<?= URL_ROOT ?>/courses/create" method="post" enctype="multipart/form-data" class="space-y-6" x-data="{ uploadMode: 'file' }">
            ...
            <div>
                ...
                <div x-show="uploadMode === 'url'" class="transition-all">
                    <input type="url" name="thumbnail_url" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary focus:outline-none transition" placeholder="https://example.com/image.jpg" value="<?= $data['thumbnail'] ?>">
                </div>
            ...
            <div class="pt-6 border-t border-gray-100 flex justify-end gap-3">
                <a href="<?= URL_ROOT ?>/creator/dashboard" class="px-6 py-2.5 bg-white border border-gray-300 rounded-full font-medium text-gray-700 hover:bg-gray-50 transition">Cancel</a>
                <button type="submit" class="px-6 py-2.5 bg-primary text-white rounded-full font-medium hover:bg-purple-800 transition shadow-sm">Create Course</button>
            </div>
        </form>
    </div>
</div>
